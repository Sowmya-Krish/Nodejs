//const express = require("express"); //importing 3rd party package---common.js
...
const app = express(); //calling 3rd party package
...
const client = new MongoClient(MONGO_URL); // making calls
await client.connect(); //call connecting
...
//common middleware- expressjason
//app.use - will apply middleware to all request

app.use(express.json());
app.get("/", function (request, response) {
  response.send("Hello Sowmi****");
});
